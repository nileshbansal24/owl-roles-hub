...
export const PersonalDetailsCard = ({
  ...
  // Calculate completion for preview text
  const filledFields = [name, familyDetails, email, phone, quotes].filter(Boolean).length;
  const filledArrays = [skills, hobbies, recommendedBooks].filter(arr => arr && arr.length > 0).length;
