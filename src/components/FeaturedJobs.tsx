            ...
            return (
              ...
              >
                ...
                <div className="flex items-start gap-3 mb-4">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="flex items-center gap-1.5 mt-0.5">
                      <p className="text-sm text-muted-foreground font-medium truncate">{job.institute}</p>
                ...
                <div className="flex flex-wrap gap-2 mb-4">
                  {job.job_type && (
                    <Badge variant="secondary" className="rounded-full text-xs">{job.job_type}</Badge>
                  )}
                ...
                <div className="flex items-center justify-between pt-3 border-t border-border">
                  ...
                  <Button size="sm" variant="ghost" className="text-primary font-semibold text-xs h-8 px-3 group-hover:bg-primary/10">
                    Apply Now →
                  </Button>
                </div>
              </motion.div>
